...
public final class ProtobufDeserializer<T extends MessageLite> implements Deserializer<T> {
    ...
    public void configure(Map<String, ?> configs, boolean isKey) {
        if (parser != null) {
            // Keep configuration idempotent for environments that may invoke configure more than once.
            return;
        }
    ...
    private static <T extends MessageLite> Parser<T> parserFromConfig(Object configuredType, String configKey) {
    ...
    private static Class<?> resolveMessageClass(Object configuredType, String configKey) {
